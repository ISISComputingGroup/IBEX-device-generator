epicsEnvSet "STREAM_PROTOCOL_PATH" "$(@{ioc_name})/data"
...
dbLoadRecords("$(@{ioc_name})/db/@{device_support_module_name}.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
