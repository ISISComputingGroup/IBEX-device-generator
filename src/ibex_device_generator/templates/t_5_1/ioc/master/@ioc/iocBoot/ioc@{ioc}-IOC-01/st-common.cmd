epicsEnvSet "STREAM_PROTOCOL_PATH" "$(@{ioc})/data"
...
dbLoadRecords("$(@{ioc})/db/@{device_}.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
